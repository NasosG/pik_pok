								...
								<div class="right-sidebar">
									...
									<div class="widget widget-jobs">
										...
										<div class="sd-title copylink">
											<ul>
												<li>
													<img style="cursor:pointer;" src="images/social3.svg" alt="image" onclick="window.open('https://www.facebook.com/')">
												</li>
												<li>
													<img style="cursor:pointer;" src="images/social5.svg" alt="image" onclick="window.open('https://www.pinterest.com/')">
												</li>
												<li>
													<img style="cursor:pointer;" src="images/social1.svg" alt="image" onclick="window.open('https://www.twitter.com/')">
												</li>
												<li>
