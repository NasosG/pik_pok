...
<body>
   ...
   <div style="font-size: 16px; line-height: 1.5; padding: 0 8px; margin: auto; margin-top: 100px; margin-bottom: 100px; padding-left: 50px; padding-right: 50px; max-width: 1050px; background:white; border-radius:4px;  border: 2px solid lightgray;">
      ...
      <div class="terms_section">
         ...
         <p>Providing our Service requires collecting and using your information. The <a href="#data-policy" target="_self">Data Policy</a> explains how we collect, use, and share information across the pik pok Products</a>. It also explains the many ways you can control your information, including in the <a href="#" target="_self">Pik-Pok Privacy and Security Settings</a>.</p>
         <br />
      </div>
      <div class="terms_section">
         ...
         <ul class="uiList">
            ...
            <li>
               <div><b>You can&#039;t violate (or help or encourage others to violate) these Terms or our policies, including in particular the <a href="./community_guidelines.php?helpref=page_content" target="_self">Pik-Pok Community Guidelines</a> or any other policies that may be added in the future.</b> Learn how to report conduct or content in our <a href="./help_center.php" target="_self">Help Center</a>.</div>
            </li>
            <li>
            ...
            <li>
               <div><b>You can&#039;t post private or confidential information or do anything that violates someone else&#039;s rights, including intellectual property.</b><br /> Learn more, including how to report content that you think infringes your intellectual property rights, <a href="./help_center.php" target="_self">here</a>.</div>
            </li>
            <li>
         ...
         <ul class="uiList">
            ...
            <li>
              You grant us the permission to display ads. We always respect your privacy. We will not sell your personal data. For example, we will not show that you liked a sponsored post created by a brand and we do not accept any kind of payment to display its ads on Pik-Pok.
            <li>
      ...
      <div class="terms_section">
         ...
         <ul class="uiList">
            ...
            <li>
               <div>You can only use our intellectual property and trademarks or similar marks as expressly permitted only with our prior permission.</div>
            </li>
            <li>
      ...
      <div class="terms_section">
         ...
         <ul class="uiList">
            <li>
               <div>Your use of our APIs is subject or related services, you will be provided with an opportunity to agree to additional terms that will also become a part of our agreement. If any of those terms conflict with this agreement, those other terms will govern.</div>
            </li>
            <li>
      ...
      <div class="terms_section">
         ...
         We may change our Service and policies, and we may need to make changes to these Terms so that they accurately reflect our Service and policies. Unless otherwise required by law, we will notify you (for example, through our Service) at least 30 days before we make changes to these Terms and give you an opportunity to review them before they go into effect. Then, if you continue to use the Service, you will be bound by the updated Terms. If you do not want to agree to these or any updated Terms, you can delete your account, <a href="./help_center.php" target="_self">here</a>. <br />
      </div>
      <br>
      You declare that you are over the age of 16. If you are under the age of 16, please have your parent or legal guardian read this with you. For users who are under the age of 16 but over the age of 13, you as the parent/legal guardian of the user declare that you have read and acknowledged Pik Pok's Privacy Policy and Terms of Use and agree to the use by your child of the the Platform and registration for an account.
      <br><br>
